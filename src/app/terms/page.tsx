    ...
    <div className="max-w-4xl mx-auto py-12 px-6 animate-fade-in">
      ...
      <div className="space-y-8">
        <div>
          ...
          <p className="text-zinc-500 dark:text-zinc-400">Última actualización: {new Date().toLocaleDateString('es-ES', { year: 'numeric', month: 'long', day: 'numeric' })}</p>
        </div>
        ...
        <div className="space-y-6 text-zinc-600 dark:text-zinc-300 leading-relaxed">
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">1. Exención de Responsabilidad de Precios</h2>
            <p className="mb-4">
          ...
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">2. Uso del Servicio</h2>
            <p className="mb-4">
          ...
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">5. Conducta del Usuario</h2>
            <p className="mb-4">
              Te comprometes a utilizar la plataforma de manera legal y respetuosa. Queda prohibido:
            </p>
            <ul className="list-disc pl-5 space-y-2 text-zinc-500 dark:text-zinc-400">
          ...
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">6. Terminación</h2>
            <p>
