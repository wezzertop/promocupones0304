  ...
  return (
    <div className="relative">
      {!showOptions ? (
        ...
        <div className="flex flex-col gap-3 bg-surface p-4 rounded-xl border border-zinc-800 shadow-xl animate-in fade-in zoom-in-95 duration-200 absolute top-0 left-0 z-50 min-w-[280px]">
