  ...
  return (
    <div className="max-w-4xl mx-auto py-12 px-6 animate-fade-in">
      ...
      <div className="text-center mb-12">
        <h1 className="text-4xl font-bold text-foreground mb-4">Reglas de la Comunidad</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-surface p-6 rounded-2xl border border-border hover:border-[#07B5A7]/30 transition-colors group">
          ...
          <h3 className="text-xl font-bold text-foreground mb-3">1. Sé Respetuoso</h3>
        ...
        <div className="bg-surface p-6 rounded-2xl border border-border hover:border-[#07B5A7]/30 transition-colors group">
          ...
          <h3 className="text-xl font-bold text-foreground mb-3">2. Ofertas Reales y Verificables</h3>
          <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed">
        ...
        <div className="bg-surface p-6 rounded-2xl border border-border hover:border-[#07B5A7]/30 transition-colors group">
          ...
          <h3 className="text-xl font-bold text-foreground mb-3">3. No Spam ni Autopromoción</h3>
          <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed">
        ...
        <div className="bg-surface p-6 rounded-2xl border border-border hover:border-[#07B5A7]/30 transition-colors group">
          ...
          <h3 className="text-xl font-bold text-foreground mb-3">4. Una Cuenta por Persona</h3>
          <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed">
      ...
      <div className="mt-12 bg-[#07B5A7]/10 border border-[#07B5A7]/20 rounded-2xl p-8 text-center">
        ...
        <h3 className="text-2xl font-bold text-foreground mb-2">Ayúdanos a mejorar</h3>
