...
export default function AdminSidebar() {
  ...
  return (
    <>
      {/* Mobile Header */}
      <div className="lg:hidden fixed top-0 left-0 right-0 h-16 bg-background border-b border-border flex items-center justify-between px-4 z-[60]">
      ...
      <aside className={cn(
        "fixed left-0 top-0 h-screen w-64 bg-background border-r border-border flex flex-col z-[58] transition-transform duration-300 lg:translate-x-0",
        isOpen ? "translate-x-0" : "-translate-x-full"
      )}>
        {/* Logo Area (Desktop) */}
        <div className="h-16 hidden lg:flex items-center px-6 border-b border-border">
