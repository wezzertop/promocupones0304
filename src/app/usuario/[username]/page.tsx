      ...
      <div className="container mx-auto px-4 -mt-20 relative z-10">
        <div className="flex flex-col md:flex-row gap-8 items-start">
          ...
          <div className="w-full md:w-80 flex-shrink-0 space-y-6">
            <div className="bg-surface rounded-2xl border border-white/5 p-6 shadow-xl backdrop-blur-sm relative overflow-hidden">
              {/* Avatar */}
              <div className="relative w-32 h-32 rounded-full border-4 border-surface shadow-2xl mx-auto md:mx-0 mb-4">
                <Image
                ...
                />
                <div className="absolute bottom-0 right-0 bg-surface rounded-full p-1">
