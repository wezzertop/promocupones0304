        ...
        <div className="border-t border-[#2d2e33] py-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-xs text-gray-500 leading-relaxed">
            <div className="space-y-2">
              ...
              <p>
                Las ofertas pueden cambiar, expirar o agotarse en cualquier periodo de tiempo, ya sea corto o largo. Cupoferta actúa únicamente como una plataforma informativa y no garantiza la disponibilidad ni el precio de los productos.
              </p>
            </div>
            <div className="space-y-2">
