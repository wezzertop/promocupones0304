...
export default function UsersClient({ initialUsers, currentUserRole, searchQuery }: UsersClientProps) {
  ...
  return (
    <div className="space-y-6">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 sticky top-14 lg:top-0 z-40 bg-background/80 backdrop-blur-md p-4 rounded-xl border border-white/5 shadow-lg">
        <div>
        ...
        <form onSubmit={handleSearch} className="relative w-full md:w-auto">
          ...
          <input
            ...
            className="bg-surface border border-white/10 text-white rounded-xl pl-10 pr-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500/50 w-full md:w-64"
          />
        </form>
      </div>
      ...
      {banModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm">
          <div className="bg-surface rounded-2xl border border-white/10 w-full max-w-md p-6">
