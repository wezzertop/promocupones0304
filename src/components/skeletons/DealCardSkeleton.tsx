...
export default function DealCardSkeleton() {
  return (
    <div className="flex flex-col md:flex-row bg-[#09090b] rounded-xl md:rounded-3xl overflow-hidden border border-white/5 h-auto md:h-[340px] animate-pulse w-full max-w-[calc(100%-1rem)] mx-auto md:max-w-none md:mx-0">
