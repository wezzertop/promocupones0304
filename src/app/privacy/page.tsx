      ...
      <div className="space-y-8">
        ...
        <div className="space-y-6 text-zinc-600 dark:text-zinc-300 leading-relaxed">
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">1. Recopilación de Información</h2>
            <p className="mb-4">
          ...
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">2. Uso de Cookies</h2>
            <p className="mb-4">
          ...
          <section className="bg-surface p-6 rounded-2xl border border-border">
            <h2 className="text-xl font-bold text-foreground mb-4">3. Seguridad de Datos</h2>
            <p>
